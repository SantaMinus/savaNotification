...
import com.sava.savaNotification.SavaNotificationApplication;
...
public class FcmClient {
    ...
    public FcmClient(FcmSettings settings) {
        ...
        try (InputStream serviceAccount = Files.newInputStream(p)) {
            ...
            SavaNotificationApplication.LOGGER.error("init fcm", e);
        }
    }
    ...
    public void subscribe(String topic, String clientToken) {
        try {
            ...
            SavaNotificationApplication.LOGGER.error("subscribe", e);
        }
    }
}